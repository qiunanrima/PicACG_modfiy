...
public class PollingXHR extends Polling {
    ...
    public static class Request extends Emitter {
        ...
        private static final MediaType BINARY_MEDIA_TYPE = MediaType.get(BINARY_CONTENT_TYPE);
        private static final MediaType TEXT_MEDIA_TYPE = MediaType.get(TEXT_CONTENT_TYPE);
