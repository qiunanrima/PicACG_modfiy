...
internal class SettingsPreviewProvider : PreviewParameterProvider<SettingsState> {
    override val values = sequenceOf(
        SettingsState(
            ...
            imageQualityIndex = 3,
            imageQualityValue = "高",
            designLanguageIndex = 1,
            designLanguageValue = "MD3E",
            themeColorIndex = 2,
            themeColorValue = "Miracle Neon",
            coilCacheSizeValue = "128 MB",
            coilCacheDraftValue = "128",
        ...
        SettingsState(
            ...
            imageQualityIndex = 1,
            imageQualityValue = "中",
            designLanguageIndex = 0,
            designLanguageValue = "MD3",
            themeColorIndex = 1,
            themeColorValue = "迷红黑",
            coilCacheSizeValue = "256 MB",
            coilCacheDraftValue = "256",
            cacheTitleValue = "42MB",
